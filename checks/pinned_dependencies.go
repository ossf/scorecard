...
func dataAsWorkflowResultPointer(data worker.FileCbData) *worklowPinningResult {
...
func dataAsResultPointer(data worker.FileCbData) *pinnedResult {
...
func isShellScriptFreeOfInsecureDownloads(c *checker.CheckRequest) (int, error) {
	var r pinnedResult
	err := worker.CheckFilesContent("*", false, c, validateShellScriptIsFreeOfInsecureDownloads, &r)
...
func isDockerfileFreeOfInsecureDownloads(c *checker.CheckRequest) (int, error) {
	var r pinnedResult
	err := worker.CheckFilesContent("*Dockerfile*", false, c, validateDockerfileIsFreeOfInsecureDownloads, &r)
...
func isDockerfilePinned(c *checker.CheckRequest) (int, error) {
	var r pinnedResult
	err := worker.CheckFilesContent("*Dockerfile*", false, c, validateDockerfileIsPinned, &r)
...
func isGitHubWorkflowScriptFreeOfInsecureDownloads(c *checker.CheckRequest) (int, error) {
	var r pinnedResult
	err := worker.CheckFilesContent(".github/workflows/*", false, c, validateGitHubWorkflowIsFreeOfInsecureDownloads, &r)
...
func isGitHubActionsWorkflowPinned(c *checker.CheckRequest) (int, error) {
	...
	err := worker.CheckFilesContent(".github/workflows/*", true, c, validateGitHubActionWorkflow, &r)
...
func validatePackageManagerFile(name string, dl checker.DetailLogger, data worker.FileCbData) (bool, error) {
