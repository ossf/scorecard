...
[Artifact-Integrity](docs/checks.md#artifact-integrity) | Do the project's releases include integrity verification files such as checksums or signatures to ensure artifacts have not been tampered with? | High | PAT, GITHUB_TOKEN | Supported |
