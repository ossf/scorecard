...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Protected tag blocks deletion",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag allows deletion",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag with nil AllowDeletions (defaults to blocked)",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
