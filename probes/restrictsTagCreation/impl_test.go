...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Tag creation is restricted",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Tag creation is not restricted",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag with nil RestrictCreation",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Multiple tags mixed restriction",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
