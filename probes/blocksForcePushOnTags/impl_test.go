...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Protected tag blocks force-push",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag allows force-push",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag with nil AllowForcePushes (defaults to blocked)",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Mixed force-push settings",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
