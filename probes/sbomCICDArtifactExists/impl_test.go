...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "CICD Sbom file found and outcome should be positive",
			raw: &checker.RawResults{
				SbomResults: checker.SbomData{
					SbomFiles: []checker.SbomFile{
						{
							SbomInformation: checker.Sbom{
								Origin: checker.SbomOriginationTypeCICD,
							},
							File: checker.File{
								Path: "sbom.cdx.json",
							},
		...
		{
			name: "CICD Sbom file not found and outcome should be negative",
			raw: &checker.RawResults{
				SbomResults: checker.SbomData{
					SbomFiles: []checker.SbomFile{
						{
