...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Protection applies to admins",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protection does not apply to admins",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Protected tag with nil EnforceAdmins",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
		...
		{
			name: "Multiple tags mixed enforcement",
			raw: &checker.RawResults{
				TagProtectionResults: checker.TagProtectionsData{
					Tags: []clients.TagRef{
						{
