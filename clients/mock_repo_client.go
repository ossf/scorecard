...
func (m *MockRepoClient) GetDefaultBranch() (BranchRef, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDefaultBranch")
	ret0, _ := ret[0].(BranchRef)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepoClient) ListCommits() ([]Commit, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoClient) ListContributors() ([]Contributor, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoClient) ListMergedPRs() ([]PullRequest, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoClient) ListReleases() ([]Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepoClient) Search(request SearchRequest) (SearchResponse, error) {
	m.ctrl.T.Helper()
