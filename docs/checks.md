...
support other source hosting repositories (i.e., Forges or GitLab). This check 
only considers repositories which run test and rewards them if they are successful.
