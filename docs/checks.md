...
hub, e.g., [npm](https://www.npmjs.com/). Go projects automatically pass this check, since
they do not require explicit publishing. We plan to add better support to query
